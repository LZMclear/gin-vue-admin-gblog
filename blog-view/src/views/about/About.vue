<template>
	<div>
		<div class="ui top attached segment m-padded-lr-big">
			...
			<meting-js server="netease" type="song" :id="about.musicId" :key="about.musicId" theme="#25CCF7" v-if="about.musicId!==''"></meting-js>
...
<script>
	...
	import {isSuccess, normalizeAbout} from "@/util/gvaResponse";
	...
	export default {
		...
		methods: {
			getData() {
				getAbout().then(res => {
					if (isSuccess(res)) {
						this.about = normalizeAbout(res.data)
					} else {
