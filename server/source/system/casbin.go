...
func (i *initCasbin) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []adapter.CasbinRule{
		...
		//添加blog相关接口权限
		{Ptype: "p", V0: "888", V1: "/admin/about", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/admin/about", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/admin/blog", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/admin/blog", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/admin/blog", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/admin/blog", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/admin/blog/recommend", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/admin/blog/top", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/admin/blogIdAndTitle", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/admin/blogs", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/admin/categories", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/admin/category", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/admin/category", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/admin/category", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/admin/categoryAndTag", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/admin/comment", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/admin/comment", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/admin/comment/notice", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/admin/comment/published", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/admin/comments", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/admin/dashboard", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/admin/exceptionLog", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/admin/exceptionLogs", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/admin/friend", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/admin/friend", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/admin/friend", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/admin/friend/published", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/admin/friendInfo", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/admin/friendInfo/commentEnable", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/admin/friendInfo/content", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/admin/friends", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/admin/moment", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/admin/moment", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/admin/moment", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/admin/moment", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/admin/moment/published", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/admin/moments", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/admin/operationLog", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/admin/operationLogs", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/admin/siteSettings", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/admin/siteSettings", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/admin/tag", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/admin/tag", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/admin/tag", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/admin/tags", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/admin/visitLog", V2: "DELETE"},
