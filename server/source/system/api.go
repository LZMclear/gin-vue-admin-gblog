...
func (i *initApi) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []sysModel.SysApi{
		...
		{ApiGroup: "gblog", Method: "POST", Path: "/admin/category", Description: "创建类别"},
		{ApiGroup: "gblog", Method: "GET", Path: "/admin/dashboard", Description: "dashboard"},
		{ApiGroup: "gblog", Method: "PUT", Path: "/admin/category", Description: "更新类别"},
		{ApiGroup: "gblog", Method: "DELETE", Path: "/admin/category", Description: "删除类别"},
		{ApiGroup: "gblog", Method: "POST", Path: "/admin/tag", Description: "创建标签"},
		{ApiGroup: "gblog", Method: "PUT", Path: "/admin/tag", Description: "更新标签"},
		{ApiGroup: "gblog", Method: "DELETE", Path: "/admin/tag", Description: "删除标签"},
		{ApiGroup: "gblog", Method: "GET", Path: "/admin/tags", Description: "获取标签列表"},
		{ApiGroup: "gblog", Method: "DELETE", Path: "/admin/blog", Description: "删除文章"},
		{ApiGroup: "gblog", Method: "POST", Path: "/admin/blog", Description: "新增文章"},
		{ApiGroup: "gblog", Method: "PUT", Path: "/admin/blog/top", Description: "文章置顶"},
		{ApiGroup: "gblog", Method: "PUT", Path: "/admin/blog/recommen", Description: "文章推荐"},
		{ApiGroup: "gblog", Method: "GET", Path: "/admin/blog", Description: "获取指定文章"},
		{ApiGroup: "gblog", Method: "PUT", Path: "/admin/blog", Description: "更新文章"},
		{ApiGroup: "gblog", Method: "GET", Path: "/admin/operationLogs", Description: "获取操作日志列表"},
		{ApiGroup: "gblog", Method: "DELETE", Path: "/admin/operationLog", Description: "删除操作日志"},
		{ApiGroup: "gblog", Method: "GET", Path: "/admin/moments", Description: "动态列表"},
		{ApiGroup: "gblog", Method: "PUT", Path: "/admin/moment/publish", Description: "更新动态可见性"},
		{ApiGroup: "gblog", Method: "GET", Path: "/admin/moment", Description: "获取指定动态信息"},
		{ApiGroup: "gblog", Method: "DELETE", Path: "/admin/moment", Description: "删除动态"},
		{ApiGroup: "gblog", Method: "POST", Path: "/admin/moment", Description: "新增动态"},
		{ApiGroup: "gblog", Method: "PUT", Path: "/admin/moment", Description: "更新动态"},
		{ApiGroup: "gblog", Method: "GET", Path: "/admin/friends", Description: "获取友链列表"},
		{ApiGroup: "gblog", Method: "GET", Path: "/admin/friendInfo", Description: "获取友链信息"},
		{ApiGroup: "gblog", Method: "POST", Path: "/admin/friend", Description: "新增友链"},
		{ApiGroup: "gblog", Method: "DELETE", Path: "/admin/friend", Description: "删除友链"},
		{ApiGroup: "gblog", Method: "PUT", Path: "/admin/friend", Description: "更新友链"},
		{ApiGroup: "gblog", Method: "PUT", Path: "/admin/friendInfo/conte", Description: "更新友链内容"},
		{ApiGroup: "gblog", Method: "PUT", Path: "/admin/friendInfo/publishe", Description: "友链公开更新"},
		{ApiGroup: "gblog", Method: "PUT", Path: "/admin/friendInfo/conn", Description: "友链评论开关"},
		{ApiGroup: "gblog", Method: "GET", Path: "/admin/siteSettings", Description: "站点信息"},
		{ApiGroup: "gblog", Method: "POST", Path: "/admin/siteSettings", Description: "更新站点设置"},
		{ApiGroup: "gblog", Method: "GET", Path: "/admin/about", Description: "关于我"},
		{ApiGroup: "gblog", Method: "PUT", Path: "/admin/about", Description: "更新关于我信息"},
		{ApiGroup: "gblog", Method: "GET", Path: "/admin/visitLogs", Description: "获取访问日志"},
		{ApiGroup: "gblog", Method: "GET", Path: "/admin/visitors", Description: "访客统计"},
		{ApiGroup: "gblog", Method: "GET", Path: "/admin/exceptionLogs", Description: "获取异常日志"},
		{ApiGroup: "gblog", Method: "DELETE", Path: "/admin/visitLog", Description: "删除访问日志"},
		{ApiGroup: "gblog", Method: "DELETE", Path: "/admin/visitor", Description: "删除访客"},
		{ApiGroup: "gblog", Method: "DELETE", Path: "/admin/exceptionLog", Description: "删除异常日志"},
		{ApiGroup: "gblog", Method: "PUT", Path: "/admin/comment", Description: "更新评论"},
		{ApiGroup: "gblog", Method: "PUT", Path: "/admin/comment/publish", Description: "更新评论可见性"},
		{ApiGroup: "gblog", Method: "DELETE", Path: "/admin/comment", Description: "删除评论"},
		{ApiGroup: "gblog", Method: "GET", Path: "/admin/comments", Description: "获取评论列表"},
		{ApiGroup: "gblog", Method: "GET", Path: "/admin/blogIdAndTitle", Description: "获取博客ID以及名称"},
		{ApiGroup: "gblog", Method: "PUT", Path: "/admin/comment/notice", Description: "未知"},
	}
